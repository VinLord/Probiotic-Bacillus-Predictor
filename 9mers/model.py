...
# File Paths
features_scores_path = r'E:\bacillus_model\9mers\9merfeatures.csv'
main_dataset_path = r'E:\bacillus_model\9mers\ninemersdata.csv'
...
if 'Label' not in main_df.columns:
    ...
    joblib.dump(best_svm_model, r'E:\bacillus_model\9mers\best_svm_model.pkl')
    joblib.dump(best_rf_model, r'E:\bacillus_model\9mers\best_rf_model.pkl')
    joblib.dump(best_xgb_model, r'E:\bacillus_model\9mers\best_xgb_model.pkl')
    joblib.dump(nb_model, r'E:\bacillus_model\9mers\best_nb_model.pkl')
    joblib.dump(best_ada_model, r'E:\bacillus_model\9mers\best_ada_model.pkl')
    joblib.dump(selected_features_names, r'E:\bacillus_model\9mers\selected_features.pkl')
