...
# File Paths
features_scores_path = r'E:\bacillus_model\7mers\7merfeatures.csv'
main_dataset_path = r'E:\bacillus_model\7mers\sevenmersdata.csv'
...
if 'Label' not in main_df.columns:
    ...
    joblib.dump(best_svm_model, r'E:\bacillus_model\7mers\best_svm_model.pkl')
    joblib.dump(best_rf_model, r'E:\bacillus_model\7mers\best_rf_model.pkl')
    joblib.dump(best_xgb_model, r'E:\bacillus_model\7mers\best_xgb_model.pkl')
    joblib.dump(nb_model, r'E:\bacillus_model\7mers\best_nb_model.pkl')
    joblib.dump(best_ada_model, r'E:\bacillus_model\7mers\best_ada_model.pkl')
    joblib.dump(selected_features_names, r'E:\bacillus_model\7mers\selected_features.pkl')
